...
$(document).ready(function() {
    ...
    var figures = [
        {name: 'crash', dimension: [90, 50, 90], position: [-95, -20, -95]},
        {name: 'crash2', dimension: [90, 50, 90], position: [0, -20, -95]},
        {name: 'ride', dimension: [90, 50, 90], position: [95, -20, -95]},
        {name: 'hitom', dimension: [90, 10, 90], position: [-95, -20, 0]},
        {name: 'midtom', dimension: [90, 10, 90], position: [0, -20, 0]}, // per ora prende solo questo
        {name: 'floortom', dimension: [90, 10, 90], position: [95, -20, 0]},
...
function findIntersections(tip, pip ) {
		...
		var pip = v( index.pipPosition[0], index.pipPosition[1], index.pipPosition[2] );*/
               ...
               // pip = new THREE.Vector3(pip[0], pip[1], pip[2]);
                  tip = new THREE.Vector3(tip[0], tip[1]-202, tip[2]);
                  pip = new THREE.Vector3(pip[0], pip[1]-202, pip[2]);
                 // console.log(tip);
